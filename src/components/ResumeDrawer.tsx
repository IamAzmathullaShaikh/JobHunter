    ...
    <div className={`fixed inset-y-0 right-0 w-full md:w-96 bg-slate-900 border-l border-slate-800 shadow-2xl z-50 transform transition-transform duration-300 ${isOpen ? "translate-x-0" : "translate-x-full"}`}>
      <div className="h-full flex flex-col p-6 space-y-6">
        ...
        <div className="flex-1 flex flex-col space-y-4 overflow-hidden">
          ...
          <div 
             onClick={() => alert("Local PDF parsing is being enabled in the next release. For now, please paste your resume text in the field above.")}
             className="bg-indigo-600/10 border border-indigo-500/20 rounded-lg p-4 cursor-pointer hover:bg-indigo-600/20 transition-all">
