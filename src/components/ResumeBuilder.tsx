    ...
    const doc = new Document({
      sections: [{
        ...
        children: [
          ...
          new Paragraph({
            text: "San Francisco, CA | alex.dev@email.com | (555) 0123-4567",
            style: "aside"
          }),
          new Paragraph({
          ...
          new Paragraph({
            children: [
              new TextRun({ text: "TECHCORP", bold: true }),
              new TextRun({ text: " | 2021 – Present", italics: true })
            ]
          }),
          new Paragraph({
            children: [
              new TextRun({ text: "Lead Full-Stack Developer", italics: true }),
            ]
          }),
          new Paragraph({ text: "• Architected and implemented a high-performance career automation engine processing 1M+ records daily." }),
          new Paragraph({ text: "• Engineered a 3-tier fallback AI routing system using Groq and Gemini, reducing operational costs by 60%." })
        ]
      }]
    });
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6">
             ...
             <div className="space-y-3">
                <button 
                  ...
                  className="w-full bg-slate-800 hover:bg-slate-700 text-white font-bold py-3 rounded-2xl flex items-center justify-center gap-2 transition-all text-xs">
        ...
        <div className="flex-1 bg-slate-900 border border-slate-800 rounded-3xl overflow-hidden flex flex-col min-h-[800px]">
           ...
           <div className="flex-1 p-8 overflow-y-auto bg-slate-950/30">
              {viewMode === "edit" ? (
                ...
                <div id="printable-resume" className="bg-white text-black w-full min-h-[1000px] shadow-2xl p-12 max-w-[800px] mx-auto font-serif">
